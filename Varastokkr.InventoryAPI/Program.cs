...
builder.Services.AddDbContext<InventoryDbContext>(options => options.UseSqlServer(dbConnectionString));
builder.Services.AddMigration<InventoryDbContext, DbSeed>();
